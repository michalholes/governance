...
- This repository is the authority corpus and governance toolkit repository.
- For governance-targeted execution, the target worktree is `/home/pi/governance`.
...
- For governance-targeted execution, run Amp from `/home/pi/patchhub`:
  `python3 scripts/am_patch.py ISSUE_ID "commit message" patches/issue_<ISSUE>_v<N>.zip --target-repo-name governance`
